...
// import 'package:polylinemap/screen/loctionSearch_screen.dart';
//
...
//     getCurrentLocation();
//     if (location == null) {
//       _getAddressFromLocation(location as LatLng);
//     }
//     _updateMarkers();
...
//         String address =
//             "${placemark.name}, ${placemark.subThoroughfare}, ${placemark.thoroughfare}, ${placemark.subLocality}, ${placemark.locality}, ${placemark.subAdministrativeArea}, ${placemark.administrativeArea}, ${placemark.postalCode}, ${placemark.country}";
//
//         setState(() {
//           PlacePickTextController.text = address;
//         });
//
//         print(address);
//       } else {
...
//         } else {
//           print('Error: No address found for the given location.');
//         }
//       } else {
...
//           return marker;
//         }).toSet();
//         _getAddressFromLocation(position); // Pass the position parameter here
//         _getLatLng();
//
//         // Print the marker's drag location
//         print('Marker Drag Location: $position');
//
//         // Print the reversed address
//         print('Reversed Address: ${PlacePickTextController.text}');
//       });
//     } catch (e) {
//       print('Error: $e');
//     }
...
//           icon: markerIcon2 ?? BitmapDescriptor.defaultMarker, // Use default if markerIcon2 is null
...
//                           onTap: () {
//                             // Print the marker's drag location
//                             print('Marker Drag Location: ${_markers.first.position}');
//
//                             // Print the reversed address
//                             print('Reversed Address: ${PlacePickTextController.text}');
//
